...
public class DESUtil {
    ...
    private static final String CIPHER_ALGORITHM = "DES/CFB/NoPadding";
    //DES key长度必须为8的整数倍
    public static final String key = "bwl@2016fighting";
    /**
     *   
     * 生成密钥key对象
     * @param keyStr 密钥字符串
...
//        String source = DESUtil.getEightByteMultypleStr(String.valueOf(id), username);
