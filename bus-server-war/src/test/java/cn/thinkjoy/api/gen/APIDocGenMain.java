...
public class APIDocGenMain {
    ...
    public static void genDoc(ApiDoc apiDoc){
        ...
        String rootPath = "//Users/wdong/workspace/bak/ucenter/ucenter-war/src/test/resources/apidoc/";
        Writer out = null;
        try {
            Template template = cfg.getTemplate("ucenter-war/src/test/resources/apidoc/apidoc.ftl");
