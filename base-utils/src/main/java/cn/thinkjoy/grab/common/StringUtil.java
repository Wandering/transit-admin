...
public class StringUtil {
	...
	public static boolean isNulOrBlank(String str) {
		return str == null || "".equals(str.trim()) || str.equals("null") || str.equals("undefined")||str=="undefined" ? true : false;
	}
...
//		System.out.println(checkEmail("huangshengqing@qtone.cn"));
