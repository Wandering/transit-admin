 ...
 *
 * Project Name: grab
 * $Id:  NewsServiceImpl.java 2016-03-04 11:58:15 $
 */
...
public class NewsServiceImpl extends AbstractPageService<IBaseDAO<News>, News> implements INewsService<IBaseDAO<News>,News>{
    @Autowired
    private INewsDAO newsDAO;

    @Override
    public IBaseDAO<News> getDao() {
        return newsDAO;
    }
